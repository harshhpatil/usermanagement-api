...
import { loginLimiter, registrationLimiter, strictLimiter, generalLimiter } from "../middlewares/rateLimiter.middleware.js";
import { 
    registrationSchema, 
    loginSchema, 
...
// Protected routes
router.get('/me', generalLimiter, authMiddleware, me);
